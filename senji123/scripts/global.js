...
function initSupabase() {
    // Supabase v2 CDN 暴露的全局对象是 supabase（函数），
    // 其 createClient 方法用于创建客户端
    if (typeof supabase === 'function' && typeof supabase.createClient === 'function') {
        try {
...
function isSupabaseReady() {
    return supabaseReady && supabase !== null && typeof supabase !== 'function';
}
